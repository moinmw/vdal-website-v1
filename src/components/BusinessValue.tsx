            ...
            {metrics.map((item, index) => {
              ...
              return (
                <Grid size={{ xs: 12, md: 4 }} key={index}>
                  {/* Motion wrapper INSIDE the Grid item to preserve layout */}
                  <Box
                    component={motion.div}
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    ...
                    <Paper
                      ...
                      sx={{
                        ...
                        "&:hover": {
                          ...
                          background:
                            "linear-gradient(135deg, rgba(58, 134, 243, 0.15) 0%, rgba(58, 134, 243, 0.05) 100%)",
                      ...
                      <Box>
                        ...
                        <Box
                          sx={{
                            height: "3px",
                            background:
                              "linear-gradient(90deg, #9DC668 0%, transparent 100%)",
                            transition:
